      ...
      <div class="col-md-6">
        <div id="carouselSpecies" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div v-for="(image, index)  in speciesImages" :key="image.media[0].identifier" class="carousel-item" :class="index === 0 ? ' active' : ''">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselSpecies" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden"></span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselSpecies" data-bs-slide="next">
